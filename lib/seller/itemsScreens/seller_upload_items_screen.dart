...
Future<void> validateUploadForm() async {
    if (imgXFile != null) {
        if (itemInfoTextEditingController.text.isNotEmpty
            ...
            var uri = Uri.parse(API.uploadItem);
            var request = http.MultipartRequest('POST', uri)
              ..fields['itemInfo'] = itemInfoTextEditingController.text.trim()
              ..fields['itemTitle'] = itemTitleTextEditingController.text.trim()
              ..fields['itemID'] = itemUniqueId
              ..fields['itemDescription'] = itemDescriptionTextEditingController.text.trim()
              ..fields['itemPrice'] = itemPriceTextEditingController.text.trim()
              ..fields['brandID'] = widget.model!.brandID.toString()  // Assuming you have widget.model in your widget
              ..fields['sellerUID'] = sellerID
              ..fields['sellerName'] = sellerName
              ..files.add(await http.MultipartFile.fromPath('image', imgXFile!.path));
